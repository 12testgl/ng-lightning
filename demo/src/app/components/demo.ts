...
const demos: any = [
  ...
  { key: 'files', ts: require('!!raw-loader!./demo/files/files.ts'), html: require('!!raw-loader!./demo/files/files.html'), readme: require('html-loader?minimize=false!markdown-loader!./demo/files/README.md'), api: require('html-loader?minimize=false!markdown-loader!./demo/files/API.md') },
