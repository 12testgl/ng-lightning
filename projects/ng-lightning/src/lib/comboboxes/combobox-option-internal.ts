...
import { NglCombobox, NglComboboxOptionItem } from './combobox';

@Component({
  // tslint:disable-next-line:component-selector
  selector: '[nglComboboxOption_]',
  templateUrl: './combobox-option-internal.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NglInternalComboboxOption implements NglComboboxOptionItem, Highlightable, OnDestroy {
